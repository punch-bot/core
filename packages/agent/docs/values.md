...
`AssistantMessageFrame`, `AssistantMessageFrameEncoder`, and `reduceAssistantMessageFrames()` come from `@punch-bot/ai`. Do not define a second frame codec or reducer.
