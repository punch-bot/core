...
} from "@punch-bot/chord/node";
import { ProcessTerminal, TuiMainScreen } from "@punch-bot/tui";
		...
		async (kind, command, sessionId, creates) => {
			...
			const reloadArtifact: FacetBundleArtifact = {
				...
				entry: {
					...
					externalImports: ["@punch-bot/chord"],
				},
				source: reloadSource,
			};
