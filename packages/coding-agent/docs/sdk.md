...
The `Agent` class (from `@punch-bot/agent`) handles the core LLM interaction. Access it via `session.agent`.
...
import { ModelRuntime } from "@punch-bot/cli";
...
import { createAgentSession, ModelRuntime } from "@punch-bot/cli";
...
```typescript
import { createAgentSession, DefaultResourceLoader } from "@punch-bot/cli";
...
```typescript
import { createAgentSession } from "@punch-bot/cli";
...
import { createAgentSession, defineTool } from "@punch-bot/cli";
...
```typescript
import type { InlineExtension } from "@punch-bot/cli";
...
```typescript
import { createEventBus, DefaultResourceLoader } from "@punch-bot/cli";
...
```typescript
import { createAgentSession, SettingsManager, SessionManager } from "@punch-bot/cli";
