...
- Llama load/download cancel now loops an abortable confirm over RPC so a finished job cannot leave a stale Stop dialog, and declining still allows a later cancel.
